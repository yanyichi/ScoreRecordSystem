...
//        GradeTracker teacherGradeTracker = new GradeTracker();
       ...
       exam3.addStudentExamScore(student2,95);
        ...
        System.out.println(GradeTool.gradeToolSingleton().findStudentRosterGrade(student2,roster));

        System.out.println(GradeTool.gradeToolSingleton().findStudentRosterGradeWithDropAssignment(student2,roster,1));

        System.out.println(GradeTool.gradeToolSingleton().getFinalGrade(student2,roster));
       ...
       assignment5.addAssignmentScore(student3,88);
        ...
        System.out.println(GradeTool.gradeToolSingleton().findStudentRosterGrade(student3,roster));

        System.out.println(GradeTool.gradeToolSingleton().findStudentRosterGradeWithDropAssignment(student3,roster,1));

        System.out.println(GradeTool.gradeToolSingleton().getFinalGrade(student3,roster));
